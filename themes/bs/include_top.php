...
<meta name="author" content="Henrik Steen [henrist.net], Kristian Saksvik Munkvold [krsjan.com]" />
...
<link href="'.ess::$s['rpath'].'/blindernuka.css?'.@filemtime(dirname(dirname(dirname(__FILE__)))."/blindernuka.css").'" rel="stylesheet" type="text/css" />
<!--[if lte IE 8]>
...
<script type="text/javascript" src="'.ess::$s['rpath'].'/blindernuka.js?update='.@filemtime(dirname(dirname(dirname(__FILE__)))."/blindernuka.js").'"></script>
<!--[if lte IE 7]>
<link rel="stylesheet" type="text/css" href="'.ess::$s['rpath'].'/blindernuka-ie7.css" />
