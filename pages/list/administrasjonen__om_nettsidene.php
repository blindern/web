<?php bs_side::set_title("Om nettsidene"); ?>
                        <img src="<?php echo bs_side::$pagedata->doc_path; ?>/graphics/images/trapp_paerealle.jpg" class="img_right" />
						<h1>Om nettsidene</h1>
                        <p>
							<strong>Henrik Steen</strong> har
							designet og utformet denne nettsiden i samr&aring;d
							med daglig leder <strong>Gro Osland</strong> og
							...
							bak fotografiene p&aring; nettsiden.
                        </p>
                        <p>
						...
						<p>
                            E-post adressen til hjemmesideoppmann er:<br />
