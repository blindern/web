<?php bs_side::set_title("Arrangementsplan"); ?>
			<?php echo get_right_img("schussrenn_2010v.jpg", null, "Schussrennet våren 2010", "Schussrennet våren 2010. Foto: Anders Fagereng"); ?> <!-- Foto: Anders Fagereng -->
			<h1>Arrangementer</h1>
			...
			<dl class="arrangementer">
				...
				<dt>18. februar</dt>
				<dd>Pygmétur til <a href="<?php echo bs_side::$pagedata->doc_path; ?>/smaabruket">Småbruket</a> (hytta)</dd>
				...
				<dt>14.-16. mai</dt>
				<dd>Hyttedugnad til <a href="<?php echo bs_side::$pagedata->doc_path; ?>/smaabruket">Småbruket</a> (etter Holmenkollstafetten)</dd>
